...
class QAWizardPage;
class QAWizardPrivate;

class  QAWizard : public QDialog
{
    Q_OBJECT
...
public:
    ...
    explicit QAWizard(QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags());
    ~QAWizard();

    int addPage(QAWizardPage *page);
    void setPage(int id, QAWizardPage *page);
    void removePage(int id);
    QAWizardPage *page(int id) const;
    bool hasVisitedPage(int id) const;
    QList<int> visitedIds() const;
    QList<int> pageIds() const;
    void setStartId(int id);
    int startId() const;
    QAWizardPage *currentPage() const;
    int currentId() const;
...
private:
    // Q_DISABLE_COPY(QAWizard)
    // Q_DECLARE_PRIVATE(QAWizard)
    ...
    friend class QAWizardPage;
};

Q_DECLARE_OPERATORS_FOR_FLAGS(QAWizard::WizardOptions)


class Q_WIDGETS_EXPORT QAWizardPage : public QWidget
{
    Q_OBJECT
...
public:
    explicit QAWizardPage(QWidget *parent = nullptr);
    ~QAWizardPage();
    ...
    void setPixmap(QAWizard::WizardPixmap which, const QPixmap &pixmap);
    QPixmap pixmap(QAWizard::WizardPixmap which) const;
    void setFinalPage(bool finalPage);
    bool isFinalPage() const;
    void setCommitPage(bool commitPage);
    bool isCommitPage() const;
    void setButtonText(QAWizard::WizardButton which, const QString &text);
    QString buttonText(QAWizard::WizardButton which) const;
...
protected:
    ...
    QAWizard *wizard() const;

private:
    // Q_DISABLE_COPY(QAWizardPage)
    // Q_DECLARE_PRIVATE(QAWizardPage)
    // Q_PRIVATE_SLOT(d_func(), void _q_maybeEmitCompleteChanged())
    // Q_PRIVATE_SLOT(d_func(), void _q_updateCachedCompleteState())

    friend class QAWizard;
    // friend class QAWizardPrivate;
};
