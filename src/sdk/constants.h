...
const char ProtoMessagesShort[] = "p";
const char ProtoMessagesLong[] = "proto-messages";
const char TelemetryEndpointShort[] = "t";
const char TelemetryEndpointLong[] = "telemetry-endpoint";
